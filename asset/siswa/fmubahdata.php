...
if ($edit){
	if ($nama==""||$tlahir==""||$tgllahir==""||$jk==""||$alamat==""||$umur==""){
		...
		mysql_query("update tb_siswa set nama='$nama', tempat_lahir='$tlahir', tgl_lahir='$tgllahir', umur='$umur', jenis_kelamin='$jk', alamat='$alamat' where id_siswa = '$id_login' ") or die(mysql_error());
		?>
        <script type="text/javascript">
