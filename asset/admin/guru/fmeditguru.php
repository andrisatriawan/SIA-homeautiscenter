...
$sql=mysql_query("select * from tb_guru where md5(id_guru) = '$id'")or die(mysql_error());
...
if ($edit){
	if ($id==""||$nama==""||$tlahir==""||$tgllahir==""||$jk=="--Pilih--"||$alamat==""||$nohp==""||$status=="--Pilih--"){
		?>
		...
		mysql_query("update tb_guru set nama='$nama', tempat_lahir='$tlahir', tgl_lahir='$tgllahir', jenis_kelamin='$jk', alamat='$alamat', no_hp='$nohp', status='$status' where md5(id_guru) = '$id' ") or die(mysql_error());
		?>
        <script type="text/javascript">
